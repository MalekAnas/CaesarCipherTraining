...
public class Main {
    ...
    public static StringBuffer encrypt(String text, int shift) {
        return getStringBuffer(text, shift);
    }

    private static StringBuffer getStringBuffer(String text, int shift) {
    ...
    public static StringBuffer decrypt(String cipher, int shift) {
        return getStringBuffer(cipher, shift);
    }

    public static void main(String[] args) {
        // write your code here

        System.out.println(Main.decrypt("govmywo dy tkfk zbyqbkwwsxq", 26 - 10).toString());


        String originalText = "welcome to java programming";
        int shiftCount = 10;
